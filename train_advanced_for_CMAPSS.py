...
import logging
from trainer_for_CMAPSS import train_utils
import torch
import warnings
import numpy as np
import random
...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='DVGTransformer', help='the name of the model')
    ...
    parser.add_argument('--lr_scheduler', type=str, choices=['step', 'exp', 'stepLR', 'fix', 'cos'], default='fix',
                        help='the learning rate schedule')
    parser.add_argument('--gamma', type=float, default=0.1, help='learning rate scheduler parameter for step and exp')
    parser.add_argument('--steps', type=str, default='80', help='the learning rate decay for step and stepLR')
